...
// Display Date
$display_date = (isset($this->settings['fes_display_date_in_list']) ? (bool) $this->settings['fes_display_date_in_list'] : false);
...
<div class="mec-fes-list">
    <?php if ($query->have_posts()) : ?>
        ...
        <?php else : ?>
            ...
            <div class="event-buy-plan-buttons" style="text-align:center; margin-bottom:20px">
                ...
                <?php else : ?>
                    <a class="button" href="<?php echo MPP_SITE_URL; ?>/product/subscription-plan-for-1-one-event-listing/">Get Pet-friendly Event</a>
                <?php endif; ?>
                <a class="button" target="_self" href="<?php echo MPP_SITE_URL; ?>/pet-friendly-events/"><span class="fa fa-redo"></span></a>
            </div>
        <?php endif; ?>
        ...
        <ul>
            ...
            ?>
                <li id="mec_fes_event_<?php echo get_the_ID(); ?>">
                    ...
                    ?>
                        <span class="mec-fes-event-export"><a href="#mec-fes-export-wrapper-<?php echo get_the_ID(); ?>" data-lity>
                                <div class="wn-p-t-right">
                                    <div class="wn-p-t-text-content"><?php echo esc_html__('Download Attendees', 'mec'); ?></div><i></i>
                                </div>
                            </a></span>
                    <?php endif; ?>

                    <span class="mec-fes-event-view"><a href="<?php the_permalink(); ?>">
                            <div class="wn-p-t-right">
                                <div class="wn-p-t-text-content"><?php echo esc_html__('View Event', 'mec'); ?></div><i></i>
                            </div>
                        </a></span>
                    <?php if (current_user_can('delete_post', get_the_ID())) : ?>
                        <span class="mec-fes-event-remove" data-confirmed="0" data-id="<?php echo get_the_ID(); ?>">
                            <div class="wn-p-t-right">
                                <div class="wn-p-t-text-content"><?php echo esc_html__('Remove Event', 'mec'); ?></div><i></i>
                            </div>
                        </span>
                    <?php endif; ?>
                    ...
                    <div class="mec-fes-export-wrapper mec-modal-wrap lity-hide" id="mec-fes-export-wrapper-<?php echo get_the_ID(); ?>" data-event-id="<?php echo get_the_ID(); ?>">
                        <div class="mec-fes-btn-date">
                            <?php $mec_repeat_info = get_post_meta(get_the_ID(), 'mec_repeat', true);
    ...
    <?php else : ?>
        ...
        <?php else : ?>
            ...
            <?php if (mpp_is_android_or_ios()) : ?>
                <a class="button" href="https://mypetsprofile.com/bbapp/screen/iap_products/">Get (1) Pet-friendly Event</a>
            <?php else : ?>
                <a class="button" href="<?php echo MPP_SITE_URL; ?>/product/subscription-plan-for-1-one-event-listing/">Get (1) Pet-friendly Event</a>
            <?php endif; ?>
            <a class="button" target="_self" href="<?php echo MPP_SITE_URL; ?>/pet-friendly-events/"><span class="fa fa-redo"></span></a>
        <?php endif; ?>
    <?php endif; ?>
