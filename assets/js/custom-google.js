/******/ (function (modules) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        (function ($) {
          $(document).ready(function () {
            if ($("#gmap").length) {
              var localized_data = Object(
                _lib_helper__WEBPACK_IMPORTED_MODULE_0__["get_dom_data"]
              )("map_data"); // initialize all vars here to avoid hoisting related misunderstanding.
  ...
  \******************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _single_listing_google_map__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
            _single_listing_google_map__WEBPACK_IMPORTED_MODULE_2__
          );
        ...
        /* harmony import */ var _single_listing_google_map_widget__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
            _single_listing_google_map_widget__WEBPACK_IMPORTED_MODULE_3__
          );
        ...
        (function () {
          ...
          function initMap() {
            var mapData = Object(
              _lib_helper__WEBPACK_IMPORTED_MODULE_0__["get_dom_data"]
            )("atbdp_map"); // Define Marker Shapes
            ...
            (function ($) {
              ...
              function atbdp_add_marker($marker, map, infowindow) {
                ...
                var icon_link = $marker.data("iconimage");

                var icon_class = $marker.data("iconclass");
                //console.log([icon, icon_link]);
              ...
              function setup_info_window() {
                ...
                abc.forEach(function (el, index) {
                  if (el.innerText === "atgm_marker") {
                    // console.log(at_icon)
                    el.innerText = " ";
                    el.innerHTML = '<i class="la '.concat(
                      at_icon,
                      ' atbd_map_marker_icon"></i>'
                    );
                  } // ${$marker.data('icon')}
                });
                document.querySelectorAll("div").forEach(function (el1, index) {
                  if (
                    el1.style.backgroundImage.split("/").pop() === 'm1.png")'
                  ) {
  ...
  \*************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function get_dom_data(key, parent) {
          ...
          var elmKey = "directorist-dom-data-" + key;
          var dataElm = parent
            ? parent.getElementsByClassName(elmKey)
            : document.getElementsByClassName(elmKey);
  ...
  \************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! ./assets/src/js/global/map-scripts/map-view.js */ "./assets/src/js/global/map-scripts/map-view.js"
        );
