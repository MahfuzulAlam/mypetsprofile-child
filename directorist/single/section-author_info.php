...
<div class="directorist-card directorist-card-author-info <?php echo esc_attr($class); ?>" <?php $listing->section_id($id); ?>>
    ...
    <div class="directorist-card__body">
        ...
        <div class="directorist-single-author-info">
            ...
            <a class="directorist-btn directorist-btn-primary directorist-btn-sm diretorist-view-profile-btn" href="<?php echo bp_core_get_userlink($author_id, false, true); ?>"><?php esc_html_e('View Profile', 'directorist'); ?></a>
