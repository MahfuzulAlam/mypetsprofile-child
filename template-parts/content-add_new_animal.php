...
<form method="post" name="add_animal" class="add-animal" enctype="multipart/form-data">
    <div class="mpp-profile-field">
        ...
        <div class="mpp-profile-body">
            <input type="text" id="animal_name" name="animal_name" class="mpp-profile-field-html" required="required" />
        </div>
    </div>
    <div class="mpp-profile-field">
    ...
    <div class="mpp-profile-field">
        <div class="mpp-profile-header"><label for="animal_collar">Collar Color</label></div>
        <div class="mpp-profile-body">
            <input type="text" id="animal_collar" name="animal_collar" class="mpp-profile-field-html" />
        </div>
    </div>
    <div class="mpp-profile-field">
        <div class="mpp-profile-header"><label for="animal_description">Description</label></div>
        <div class="mpp-profile-body">
            <textarea id="animal_description" name="animal_description" class="mpp-profile-field-html"></textarea>
        </div>
    </div>
    <div class="mpp-profile-field">
