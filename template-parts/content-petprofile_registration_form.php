    ...
    <form action="" name="signup_form" id="signup-form" class="standard-form signup-form clearfix" method="post" enctype="multipart/form-data">
        <div class="layout-wrap">
            ...
            <div class="register-section extended-profile" id="profile-details-section">
                <div class="editfield field_1 field_pet-name field_order_0 required-field visibility-public field_type_textbox">
                    <fieldset>
                        <legend id="field_1-1">Your Pet Name </legend>
                        <input id="field_1" name="pet_name" type="text" value="" aria-required="true" aria-labelledby="field_1-1" aria-describedby="field_1-3" />
                    </fieldset>
                </div>
            </div>
        </div>
